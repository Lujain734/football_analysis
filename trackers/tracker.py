...
class Tracker:
    ...
    def add_position_to_tracks(self, tracks):  # ✅ Fixed typo: sekf -> self
    ...
    def draw_triangle(self, frame, bbox, color):  # ✅ Fixed typo: draw_traingle -> draw_triangle
        y = int(bbox[1])
    ...
    def draw_annotations(self, video_frames, tracks, team_ball_control, target_id=None):
        ...
        for frame_num, frame in enumerate(video_frames):
            ...
            for player_id, track in tracks['players'][frame_num].items():
                ...
                if target_id is not None and int(player_id) == target_id:
                    ...
                    # 🟦 Draw other players with their team color
